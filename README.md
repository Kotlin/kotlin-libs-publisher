[![Gradle Plugin Portal](https://img.shields.io/gradle-plugin-portal/v/ru.ileasile.kotlin.publisher?label=publisher%20plugin)](https://plugins.gradle.org/plugin/ru.ileasile.kotlin.publisher)
